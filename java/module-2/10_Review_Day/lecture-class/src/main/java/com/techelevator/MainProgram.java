...
public class MainProgram {
    ...
    public static void main(String[] args) {
        ...
        //TODO:Use the Hero DAO to save the new Hero to the Database
        ...
        while (!gameOver){
            ...
            if(monster != null){
                ...
                console.printGameOverMessage();
                gameOver = true;
                //TODO:Use the Hero DAO to save the updated Hero to the Database
                heroDao.updateHero(myHero);
    ...
    public static List<Profession> getProfessionList(){
        //TODO:Use the Hero DAO to create the collection of Professions
