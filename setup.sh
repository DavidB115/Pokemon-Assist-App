...
# The URL should look something like: "https://git.techelevator.com/campuses/nlr/jan-2022/java-green/instructor-code.git"

upstream_repo="https://git.techelevator.com/campuses/nlr/sep-2023/java-blue/instructor-code.git"
